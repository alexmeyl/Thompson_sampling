...
1. Observe context for all actions  
2. Sample parameter vector using Thompson Sampling  
3. Score each action using sampled model  
4. Select best action (or no action)  
5. Convert score into probability  
6. Sample final action stochastically  
7. Observe reward  
8. Update posterior distribution over parameters  
